...
const Login = () => {
  ...
  <Link to="/signup" className="text-blue-500 font-medium">
    Sign Up
      ...
      <img src="logo.png" alt="Company Logo" className="w-24 h-24 mx-auto mt-6" />
      ...
      <form className="border border-gray-200 rounded-xl p-6 w-full max-w-md mx-auto bg-white">
        ...
        <div className="flex flex-col gap-1 mb-4">
          ...
          <input
            ...
            placeholder={activeTab === "email" ? "name@company.com" : "Enter your username"}
        ...
        <div className="flex flex-col gap-1 mb-4">
          <div className="flex justify-between items-center">
            <label className="text-sm font-medium text-[#1B2B4B]">Password</label>
...
<input type="checkbox" />          <span className="text-sm text-gray-500">Remember me for 30 days</span>
        </label>
